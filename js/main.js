        ...
        onEachFeature: function GetFeature(feature, layer){
            ...
            layer.on({
                click: function (e){
                    ...
                    createChart(feature.properties.name,populationArrays,population.dimension.Alue.category.index[areaCode]);
                    layer.setStyle({
                        color: 'green'
                    })
...
function createChart(name, populationArrays, index){
